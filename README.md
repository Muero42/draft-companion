...
> **Current source candidate:** v11.8.0-rc4.174 Season Companion startup-resilience candidate. **Android rc4.172 is observed/rejected**: screenshot shows ranking freshness rendered while Sleeper live-state freshness and refresh controls never completed.
