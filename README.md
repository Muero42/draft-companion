# Draft Companion – Final Draft Edition 2026 (v9.1.0)
...
## v9.1.0 – FantasyPros Ranking-Fix
...
## v9.1.0 – Expert-Overall + Sleeper-ADP
...
## v9.1.0 – verifizierte Experten + Sleeper-ADP
...
- Service-Worker-Cache wurde auf v9.1.0 angehoben, damit alte JS-Dateien nicht weiter ausgeliefert werden.


## v9.1.0 – echtes Expertenranking statt ECR-Spalte
...
## v9.1.0 – keine unverifizierten Rankings mehr im Panel
...
## v9.1.0 – Architekturwechsel: öffentliche Expertenranglisten

Die Einzelranking-Pipeline nutzt nicht mehr die mehrdeutigen FantasyPros-API-Rankingfelder.

- Die FantasyPros-API wird nur noch verwendet, um die verfügbaren Experten zu erkennen.
- Für jeden ausgewählten Experten wird dessen öffentliche FantasyPros-Draft-Rankingseite geladen.
- Aus dieser Seite wird die sichtbare `Rank`-Spalte extrahiert – genau die Rangfolge, die der Nutzer auf FantasyPros sieht.
- Half-PPR und Draft werden explizit gesetzt.
- Jede Liste muss mindestens 40 verwertbare Spieler enthalten und zur angeforderten Expertenseite passen.
- Nur so validierte Listen erhalten `verifiedIndividual=true` und dürfen ins Panel.
- Alte API-Rankingcaches werden verworfen (Schema v7).
- Sleeper-Draft, Sleeper-ADP und Pick-Erkennung bleiben unverändert.
- Der Snapshot zeigt Quelle und Aktualisierungsstand jedes verwendeten Experten.
