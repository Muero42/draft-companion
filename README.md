> **LOCAL CANDIDATE — v11.8.0-rc4.208**: bounded selected-weekly identity-resolver repair only; exact numeric public-directory fallback, no authority promotion, merge, deployment, or physical acceptance claim.
