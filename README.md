# Draft Companion – Final Draft Edition 2026 (v9.7.0)
...
## v9.7.0 – FantasyPros Ranking-Fix
...
## v9.7.0 – Expert-Overall + Sleeper-ADP
...
## v9.7.0 – verifizierte Experten + Sleeper-ADP
...
- Service-Worker-Cache wurde auf v9.7.0 angehoben, damit alte JS-Dateien nicht weiter ausgeliefert werden.


## v9.7.0 – echtes Expertenranking statt ECR-Spalte
...
## v9.7.0 – keine unverifizierten Rankings mehr im Panel
...
## v9.7.0 – verifizierte API-Einzelrankings
...
## v9.7.0 – Draft-Expertenquelle korrigiert
...
## v9.7.0 – Multi-Source Expertenpipeline
...
## v9.7.0 – generische Comparison-Rekonstruktion
...
## v9.7.0 – Original-Overall + Qualitätsgate
