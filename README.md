...
> **Current source candidate:** v11.8.0-rc4.167 Season Companion preview. **Android authority remains accepted v11.8.0-rc4.163** until rc4.166 passes CI and device end-to-end acceptance.
...
- v11.8.0-rc4.167 — fixes startup season hydration render ordering: canonical live `lastDraftContext` is established before Waiver/FA and Trade surfaces render. Physical Android acceptance pending.
