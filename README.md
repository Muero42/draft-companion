...
> **Current main/source:** v11.8.0-rc4.101; critical rc4.100 live-analysis const-reassignment crash fixed and merged.
> **rc4.100 PR validation:** release 33205458705 PASS; package/re-extract 33205458721 PASS; guardrails 33205458745 PASS.
> **Deployment/device:** gh-pages v11.8.0-rc4.101 with packaged-runtime parity; Android/PWA rc4.101 live rerun PASS (fresh snapshot, 341 candidates, Draft Coach rendered).
> **Rollback reference:** v11.8.0-rc4.96 historical only; current accepted Android authority is v11.8.0-rc4.101.
...
> **Current gate:** DRAFT_DAY_FRESHNESS_AND_EVIDENCE.
