...
> **Current source candidate:** v11.8.0-rc4.190 Season Companion review candidate. Waiver/team-needs v3 evaluates live Sleeper roster geometry, protected active positions, future D/ST capacity, and evidence freshness without executing transactions. This is source/package status only: no deployment or device acceptance is claimed; rc4.169 remains accepted rollback authority.
