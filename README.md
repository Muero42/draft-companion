> **LOCAL CANDIDATE — v11.8.0-rc4.210**: bounded FantasyPros request-start pacing repair only; selected identity semantics unchanged, no authority promotion, merge, deployment, or physical acceptance claim.
