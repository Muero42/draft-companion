...
> **Current source candidate:** v11.8.0-rc4.180 main candidate. rc4.177 adds a pre-network JavaScript execution marker plus a bounded 26-second fail-closed Season bootstrap watchdog after the rc4.176 Android screenshot remained on static HTML placeholders. Physical Android/PWA promotion is still pending strict automated validation; rc4.169 remains accepted rollback authority; no device trial-and-error.
