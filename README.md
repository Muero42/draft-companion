...
> **Current source candidate:** v11.8.0-rc4.190 Season waiver-semantics candidate. It fails closed on stale skill-position swap evidence, refreshes the pre-Week-1 DST waiver board against LIVE Sleeper ownership, and gates QB2 opportunities with current weekly evidence. Physical Android rc4.188 has passed the live Waiver/FA route canary; rc4.169 remains accepted rollback authority until rc4.190 is physically verified.
