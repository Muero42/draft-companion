> **CURRENT AUTHORITY — v264 (`20260923T1915Z-v264`)**: `v11.8.0-rc4.207` is canonical source and Production authority at `main@90a87948d03264860978e6150ec22d9352694448` (tree `a5f55cba7e8d114de552060b0dd96565ee400d10`), Cloudflare deployment `ac148866-adac-4a2f-9c3e-34475daf38b6`. Public rc4.207 bytes and complete 2026 Week-3 game context (16 ESPN CDN events) pass. Physical/device acceptance remains pending; rc4.205 remains last device-accepted control. Broad ECR stays separate and Team Total stays unavailable. Next gate: `RC4207_PHYSICAL_DEVICE_VERIFICATION_PENDING`.

> **HISTORICAL AUTHORITY — v263**: rc4.206 physical failure was reconciled and rc4.207 was an exact-head validated Draft PR before the authorized merge/deployment.
