...
> **Current source candidate:** v11.8.0-rc4.193 cache-distinct weekly-projection diagnostic candidate. It preserves the strict Watcher v1/v2 and Season Evidence boundaries while giving the merged authenticated FantasyPros weekly diagnostic a new PWA/service-worker identity. Physical Android rc4.188 remains the latest observed PASS; rc4.169 remains accepted rollback authority. rc4.193 deployment and physical acceptance are not claimed.
> **Deployment boundary:** Cloudflare production was observed serving the diagnostic under reused rc4.192 identity; rc4.193 parity remains UNKNOWN_REQUIRES_REVERIFICATION. PR #121/v233 is MERGED/HISTORICAL; rc4.190 is historical deployment context.
