...
> **DRAFT CANDIDATE — v11.8.0-rc4.206 / PR #191**: bounded independent-evidence repair only. Exact-ID selected weekly PITTI ranks and canonical ESPN game-context acquisition are under branch/preview validation. Broad ECR remains separate, Team Total remains fail-closed unavailable, and no merge/Production/device acceptance is claimed.
