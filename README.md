# Draft Companion – Final Draft Edition 2026 (v9.6.1)
...
## v9.6.1 – FantasyPros Ranking-Fix
...
## v9.6.1 – Expert-Overall + Sleeper-ADP
...
## v9.6.1 – verifizierte Experten + Sleeper-ADP
...
- Service-Worker-Cache wurde auf v9.6.1 angehoben, damit alte JS-Dateien nicht weiter ausgeliefert werden.


## v9.6.1 – echtes Expertenranking statt ECR-Spalte
...
## v9.6.1 – keine unverifizierten Rankings mehr im Panel
...
## v9.6.1 – verifizierte API-Einzelrankings
...
## v9.6.1 – Draft-Expertenquelle korrigiert
...
## v9.6.1 – Multi-Source Expertenpipeline
...
## v9.6.1 – generische Comparison-Rekonstruktion
...
## v9.6.1 – Original-Overall + Qualitätsgate
