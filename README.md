...
> **Current source candidate:** v11.8.0-rc4.176 regression-repair candidate on PR #97 only, superseding the v11.8.0-rc4.174 candidate and the broken rc4.175 main runtime. Restores the full rc4.174 runtime after rc4.175 truncation; no Android installation/promotion until all automated gates are green.
