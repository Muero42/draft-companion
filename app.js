...
const APP_VERSION='v11.8.0-rc4.102';
...
const RESEARCH_RESIDUAL_PRIORS={
  ...
  [norm('Josh Jacobs')]:{pos:'RB',expiresAt:Date.parse('2026-09-02T12:00:00Z'),components:[{kind:'current_availability_context',dir:0,strength:1,confidence:.94,displayRisk:true,causal:'Leistenverletzung: am 18.8. ins Training zurückgekehrt. Zusätzlich seit 27.8. zwei Misdemeanor-Anklagen; NFL prüft den Vorgang, bislang keine Sperre angekündigt',invalidator:'volle normale Workload plus geklärter NFL-Disziplinarstatus'}]},
