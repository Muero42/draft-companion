...
const RESEARCH_RESIDUAL_PRIORS={
  ...
  [norm('A.J. Brown')]:{pos:'WR',expiresAt:Date.parse('2026-09-02T12:00:00Z'),components:[{kind:'alpha_role_rebound',dir:0,strength:1,confidence:.90,display:true,causal:'New England hat Brown als primären Perimeter-/Red-Zone-Receiver neben Drake Maye aufgebaut; etablierte Elite-Effizienz und Alpha-Target-Historie geben weiterhin WR1/2-Ceiling',invalidator:'Target-/First-Read-Anteil oder Separation fällt klar unter frühere Alpha-Werte'},{kind:'age_soft_tissue',dir:0,strength:1,confidence:.88,displayRisk:true,causal:'Mit 29 und wiederkehrender Soft-Tissue-Historie ist Availability/Separation weniger bankable als beim Peak; das erhöht Varianz, ohne den Alpha-Ceiling zu entfernen',invalidator:'volle Trainings-/Spielbelastung bei stabiler Separation'}]},
