...
## 2026-08-28 04:xx CEST — fresh last-24h delta
- FantasyPros Aug27 sleeper consensus (25 experts) currently has Jonah Coleman #1 RB sleeper and Tank Bigsby #6; both deserve active late-RB research attention rather than being buried behind older priors.
- Jadarian Price Aug26 player note: first-round Seattle rookie, clear feature-back path while Charbonnet recovery timetable remains uncertain; passing-game evidence is thin (13 college targets over last two seasons), so ceiling is high but three-down certainty must NOT be assumed. Fresh news also says Price returned to practice from a leg issue. Keep ↑↑ opportunity marker with receiving-role qualifier.
- Tank Bigsby: multiple recent expert cases converge on standalone split potential plus immediate RB1 contingent value if Barkley misses time; strong late-round asymmetry. Do not convert Barkley age/injury history into an assumed injury probability.
