const CACHE='draft-companion-v11.8.0-rc4.136';
const BACKUP_CACHE='draft-companion-backup-export-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=v11.8.0-rc4.136','./decision-policy.js','./manifest.webmanifest','./icon.svg','./live-surface-v3.js?v=v11.8.0-rc4.136','./live-surface-v3.css?v=v11.8.0-rc4.136','./expert-board-export.js?v=20260826e','./expert-v2-board.js?v=20260826e','./expert-v3-board.js?v=20260828a'];
const BASE='v11.8.0-rc4.136',TARGET='v11.8.0-rc4.136';
function patchApp(s){
