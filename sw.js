const CACHE='draft-companion-v11.8.0-rc4.64';
const BACKUP_CACHE='draft-companion-backup-export-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=11.8.0-rc4.61','./manifest.webmanifest','./icon.svg','./live-surface-v3.js','./live-surface-v3.css','./expert-board-export.js?v=20260826d'];
const BASE='v11.8.0-rc4.64',TARGET='v11.8.0-rc4.64';
function patchApp(s){
