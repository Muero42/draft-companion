const CACHE='draft-companion-v11.8.0-rc4.77';
const BACKUP_CACHE='draft-companion-backup-export-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=v11.8.0-rc4.77','./manifest.webmanifest','./icon.svg','./live-surface-v3.js?v=v11.8.0-rc4.77','./live-surface-v3.css?v=v11.8.0-rc4.77','./expert-board-export.js?v=20260826e'];
const BASE='v11.8.0-rc4.77',TARGET='v11.8.0-rc4.77';
function patchApp(s){
