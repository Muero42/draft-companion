const CACHE='draft-companion-v11.8.0-rc4.83';
const BACKUP_CACHE='draft-companion-backup-export-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=v11.8.0-rc4.83','./decision-policy.js','./manifest.webmanifest','./icon.svg','./live-surface-v3.js?v=v11.8.0-rc4.83','./live-surface-v3.css?v=v11.8.0-rc4.83','./expert-board-export.js?v=20260826e'];
const BASE='v11.8.0-rc4.83',TARGET='v11.8.0-rc4.83';
function patchApp(s){
