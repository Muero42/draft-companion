const CACHE='draft-companion-v11.8.0-rc4.107';
const BACKUP_CACHE='draft-companion-backup-export-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=v11.8.0-rc4.107','./decision-policy.js','./manifest.webmanifest','./icon.svg','./live-surface-v3.js?v=v11.8.0-rc4.107','./live-surface-v3.css?v=v11.8.0-rc4.107','./expert-board-export.js?v=20260826e','./expert-v2-board.js?v=20260826e','./expert-v3-board.js?v=20260828a'];
const BASE='v11.8.0-rc4.107',TARGET='v11.8.0-rc4.107';
function patchApp(s){
