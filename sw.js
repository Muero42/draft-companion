const CACHE='draft-companion-v11.8.0-rc4.76';
const BACKUP_CACHE='draft-companion-backup-export-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=v11.8.0-rc4.76','./manifest.webmanifest','./icon.svg','./live-surface-v3.js?v=v11.8.0-rc4.76','./live-surface-v3.css?v=v11.8.0-rc4.76','./expert-board-export.js?v=20260826e'];
const BASE='v11.8.0-rc4.76',TARGET='v11.8.0-rc4.76';
function patchApp(s){
