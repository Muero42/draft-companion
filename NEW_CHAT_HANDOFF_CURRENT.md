...
Handoff generation: `20260829T0945Z-v173`
Updated: 2026-08-29 09:45Z

## FAIL-CLOSED TAKEOVER
1. Read PITTI_COMMAND_CONTRACTS.json.
2. Read PITTI_CURRENT_STATE.json.
3. Read PITTI_HANDOFF_SEAL.json and require generation `20260829T0945Z-v173`, PASS, handoff_ready=true, second_pass_pass=true, non-empty integrity map.
