...
Historical v234 branch/base/PR evidence is stored in PITTI_CURRENT_STATE.json historical_superseded.v234_local_request; current branch and file authority must be verified dynamically.
