Handoff generation: `20260924T0945Z-v265`
...
> **HISTORICAL AUTHORITY — v263**: `v11.8.0-rc4.206` is canonical source and Production at `main@d5954d66877df877f950a4a41f32baad59a66748`, deployment `8322e9b3-a293-4454-8ef9-d5e98c217889`, but device acceptance is false (`RC4.206_PHYSICAL_PARTIAL_PASS_NOT_ACCEPTED_SELECTED_PANEL_AND_GAME_CONTEXT_UNAVAILABLE`). rc4.205 is the last device-accepted control. rc4.207 is an unmerged repair candidate. PR #192 is stale and must not be merged unchanged. Team Total remains unavailable. Gate: `RC4207_EXACT_HEAD_CI_AND_NONPRODUCTION_PREVIEW`.
...
Handoff generation: `20260920T1100Z-v260`
...
Handoff generation: `20260911T1352Z-v242`
Created: 2026-09-03T09:59:50.439Z

## CURRENT AUTHORITY
Source/runtime v11.8.0-rc4.196 was freshly observed merged through PR #143: source head `69a0593410ab5db754090a01d5b0e5beef2ed38b`, historical base `8aedc4ea3b7b71591cbc45f971ccf85fe5167074`, merge commit `555487237c9075d5e5ceeb1fee196f4763f87cc3`. Exact-main-head GitHub checks passed at reconciliation time. These SHAs and results are timestamped provenance only and must be reverified dynamically. rc4.195 remains production/device authority. rc4.196 deployment parity is UNKNOWN_REQUIRES_REVERIFICATION and it is not physically accepted. PR #143 / rc4.196 is MERGED/HISTORICAL.

## CODEX
The original checkout at `C:\Users\timmu\Documents\PITTI-Codex` contained untracked user files and was left untouched. Reconciliation runs on `pitti/rc4196-postmerge-authority-reconcile`. Dynamic takeover verified origin/main at `555487237c9075d5e5ceeb1fee196f4763f87cc3`, merged PR #143, and Draft PR #145 before checkpoint editing.

## CURRENT GATE
`VERIFY_CANONICAL_AUTHORITY_THEN_AUTHORIZED_WORK`. Before continuation or promotion, dynamically verify local repository identity, branch, HEAD and working tree against canonical Git/GitHub remote, main HEAD, relevant PR state and exact-head CI. If evidence is unavailable or contradictory, stop the dependent action fail-closed. Then follow the currently user-authorized work package. A source commit or merge never proves deployment parity or physical device acceptance.
...
Earlier rc4.190/rc4.192/rc4.194 identities remain historical. rc4.193 physical Weekly-Evidence PASS is preserved; rc4.195 remains production/device accepted; rc4.196 source is merged but remains undeployed/unverified and device-unverified. Live audit remains Boone 263/264 overall, PITTI 15/15, opponents 119/119 mapped; ambiguous/unavailable/stale or partial evidence remains fail-closed.
> CURRENT v263 (`20260923T1834Z-v263`): rc4.206 is source + Production authority at `main@d5954d66877df877f950a4a41f32baad59a66748`, deployment `8322e9b3-a293-4454-8ef9-d5e98c217889`, but device acceptance is false (`RC4.206_PHYSICAL_PARTIAL_PASS_NOT_ACCEPTED_SELECTED_PANEL_AND_GAME_CONTEXT_UNAVAILABLE`). rc4.205 remains last device-accepted control. rc4.207 is not merged/deployed. Team Total stays unavailable. PR #192 must not be merged unchanged. Gate: `RC4207_EXACT_HEAD_CI_AND_NONPRODUCTION_PREVIEW`.
Handoff generation: `20260923T1834Z-v263`
