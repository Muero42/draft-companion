...
Historical v235 branch/base/PR evidence is stored in PITTI_CURRENT_STATE.json historical_superseded.v235_local_request; current branch and file authority must be verified dynamically.
