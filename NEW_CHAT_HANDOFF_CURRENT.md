...
> **CURRENT AUTHORITY — v263**: `v11.8.0-rc4.206` is canonical source and Production at `main@d5954d66877df877f950a4a41f32baad59a66748`, deployment `8322e9b3-a293-4454-8ef9-d5e98c217889`, but device acceptance is false (`RC4.206_PHYSICAL_PARTIAL_PASS_NOT_ACCEPTED_SELECTED_PANEL_AND_GAME_CONTEXT_UNAVAILABLE`). rc4.205 is the last device-accepted control. rc4.207 is an unmerged repair candidate. PR #192 is stale and must not be merged unchanged. Team Total remains unavailable. Gate: `RC4207_EXACT_HEAD_CI_AND_NONPRODUCTION_PREVIEW`.
