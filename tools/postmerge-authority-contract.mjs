...
export function validateAuthority(data) {
  ...
  check(rc4196?.checkpoint==='v243'&&rc4196.pr===143&&rc4196.status==='MERGED/HISTORICAL'&&rc4196.source_head==='69a0593410ab5db754090a01d5b0e5beef2ed38b'&&rc4196.base_head==='8aedc4ea3b7b71591cbc45f971ccf85fe5167074'&&rc4196.merge_commit==='555487237c9075d5e5ceeb1fee196f4763f87cc3'&&rc4196.deployment_proven===true&&rc4196.device_acceptance_proven===false&&String(rc4196.evidence_scope||'').includes('PR #143 merge provenance'),'CURRENT.authority.rc4196_source_merge','PR #143 merge provenance and separate deployment/device boundaries required');
