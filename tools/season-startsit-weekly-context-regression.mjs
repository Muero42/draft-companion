...
const incompleteEvents=events.map(x=>structuredClone(x));incompleteEvents[2]={id:'3',date:new Date(now+9999).toISOString(),competitions:[{competitors:[{homeAway:'home',team:{abbreviation:'EEE'}},{homeAway:'away',team:{abbreviation:'FFF'}}]}]};
