...
must(app.includes("const weekly=Number.isFinite(structural?.lineupGain)?Number(structural.lineupGain):null"),'THIS WEEK waiver horizon must use verified legal-lineup projection gain');
...
if(current.mode==='POST_DRAFT_SEASON_COMPANION'){
  ...
  must(['v11.8.0-rc4.192','v11.8.0-rc4.193','v11.8.0-rc4.194','v11.8.0-rc4.195','v11.8.0-rc4.196','v11.8.0-rc4.197','v11.8.0-rc4.198','v11.8.0-rc4.200','v11.8.0-rc4.201','v11.8.0-rc4.202','v11.8.0-rc4.203','v11.8.0-rc4.204'].includes(current.authority?.source_candidate),'Season Companion source candidate regression');
