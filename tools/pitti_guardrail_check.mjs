...
if(current.mode==='POST_DRAFT_SEASON_COMPANION'){
  ...
  must(['v11.8.0-rc4.161','v11.8.0-rc4.162','v11.8.0-rc4.163','v11.8.0-rc4.164','v11.8.0-rc4.165','v11.8.0-rc4.166','v11.8.0-rc4.167','v11.8.0-rc4.168','v11.8.0-rc4.169','v11.8.0-rc4.170','v11.8.0-rc4.171','v11.8.0-rc4.172','v11.8.0-rc4.173','v11.8.0-rc4.174','v11.8.0-rc4.175','v11.8.0-rc4.176','v11.8.0-rc4.177','v11.8.0-rc4.178','v11.8.0-rc4.179'].includes(current.authority?.source_candidate),'Season Companion source candidate regression');
  must(['DEVICE_RC4161_ACCEPTANCE','SEASON_ACTIONABILITY_INCREMENT','DEVICE_RC4163_SEASON_SURFACES','DEVICE_RC4164_LIVE_SEASON_HYDRATION','SELFTEST_RC4165_SEASON_STARTUP','DEVICE_RC4165_FINAL_CANARY','RC4166_CI_AND_PREVIEW_DEPLOY','DEVICE_RC4166_FINAL_CANARY','VERIFY_RC4167_PREVIEW_THEN_SINGLE_DEVICE_CANARY','RC4168_PARITY_THEN_DEVICE_REFRESH','RC4169_PREVIEW_PARITY_THEN_DEVICE_REFRESH','RC4170_PREVIEW_THEN_DEVICE_REFRESH','AUTOMATED_SEASON_E2E_BEFORE_ANY_DEVICE_UPDATE','FINAL_DEVICE_CONFIRMATION_AFTER_RESEAL','RC4177_STRICT_VALIDATION','DEVICE_RC4177_DIAGNOSTIC_CANARY','RC4178_STRICT_VALIDATION','RC4179_STRICT_VALIDATION'].includes(commandContract.currentGate),'Season Companion command gate regression');
  must(['DEVICE_RC4161_ACCEPTANCE','SEASON_ACTIONABILITY_INCREMENT','DEVICE_RC4163_SEASON_SURFACES','DEVICE_RC4164_LIVE_SEASON_HYDRATION','SELFTEST_RC4165_SEASON_STARTUP','DEVICE_RC4165_FINAL_CANARY','RC4166_CI_AND_PREVIEW_DEPLOY','DEVICE_RC4166_FINAL_CANARY','VERIFY_RC4167_PREVIEW_THEN_SINGLE_DEVICE_CANARY','RC4168_PARITY_THEN_DEVICE_REFRESH','RC4169_PREVIEW_PARITY_THEN_DEVICE_REFRESH','RC4170_PREVIEW_THEN_DEVICE_REFRESH','AUTOMATED_SEASON_E2E_BEFORE_ANY_DEVICE_UPDATE','FINAL_DEVICE_CONFIRMATION_AFTER_RESEAL','RC4177_STRICT_VALIDATION','DEVICE_RC4177_DIAGNOSTIC_CANARY','RC4178_STRICT_VALIDATION','RC4179_STRICT_VALIDATION'].includes(lock.gate),'Season Companion lock gate regression');
  must(['DEVICE_RC4161_ACCEPTANCE','SEASON_ACTIONABILITY_INCREMENT','DEVICE_RC4163_SEASON_SURFACES','DEVICE_RC4164_LIVE_SEASON_HYDRATION','SELFTEST_RC4165_SEASON_STARTUP','DEVICE_RC4165_FINAL_CANARY','RC4166_CI_AND_PREVIEW_DEPLOY','DEVICE_RC4166_FINAL_CANARY','RC4167_ALL_GATES_THEN_SINGLE_PREVIEW_DEPLOY','VERIFY_RC4167_PREVIEW_THEN_SINGLE_DEVICE_CANARY','RC4168_PARITY_THEN_DEVICE_REFRESH','RC4169_PREVIEW_PARITY_THEN_DEVICE_REFRESH','RC4170_PREVIEW_THEN_DEVICE_REFRESH','AUTOMATED_SEASON_E2E_BEFORE_ANY_DEVICE_UPDATE','FINAL_DEVICE_CONFIRMATION_AFTER_RESEAL','RC4177_STRICT_VALIDATION','DEVICE_RC4177_DIAGNOSTIC_CANARY','RC4178_STRICT_VALIDATION','RC4179_STRICT_VALIDATION'].includes(current.currentWork?.nextGate),'Season Companion CURRENT next gate regression');
