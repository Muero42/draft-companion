...
const ctx=b.indexOf('lastDraftContext={id,current:total');const waiver=b.indexOf('renderWaiverWorkspace(true)');const action=b.indexOf('renderSeasonActionBoard(true)');
if(ctx<0||waiver<0||action<0)throw new Error('season bootstrap tokens missing');
if(!(ctx<waiver&&ctx<action))throw new Error('season surfaces render before lastDraftContext hydration');
