...
const appVersion=(fs.readFileSync('app.js','utf8').match(/const APP_VERSION='([^']+)'/)||[])[1],lockVersion=JSON.parse(fs.readFileSync('PITTI_EXECUTION_LOCK.json','utf8')).runtime?.appVersion;
const candidatePreflight=appVersion!==lockVersion;
const tests=new Map();
...
tests.set('tools/weekly-evidence-v2-regression.mjs',['tools/weekly-evidence-v2-regression.mjs']);
