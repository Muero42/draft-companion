...
must(s(7,3,109)===-16.5,'WR7/RB3 imbalance must carry extra soft opportunity cost');
must(s(8,2,112)===-19.5,'WR8/RB2 imbalance must carry extra soft opportunity cost');
must(s(7,4,109)===-10.5,'extra imbalance term must not activate once RB4 exists');
