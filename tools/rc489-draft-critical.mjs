...
for(const [n,s] of [['app',app],['index',idx],['sw',sw]])assert.match(s,/v11\.8\.0-rc4\.(?:89|9\d|[1-9]\d{2,})/,n+' rc4.89+ version mismatch');
assert.ok(live.includes("expertv3:'Expert-v3 BASELINE'"));
...
const p=ctx.window.PITTI_LIVE_PRESENTATION_V3;assert.equal(p.profileLabel(),'Expert-v3 BASELINE');
