...
check(sandbox.seasonTradeDecision(mine,opp,[mine[2]],[opp[2]],season).status!=='DRAFT_PREFERENCE_UNRESOLVED','Week 2+ disables hard pre-Week-1 draft-capital veto');
const ambiguous={...season,transaction_round:null,league:{...season.league,settings:{}}};
check(sandbox.seasonTradeDecision(mine,opp,[mine[2]],[opp[2]],ambiguous).status==='TEMPORAL_STATE_UNVERIFIED','ambiguous temporal authority fails closed');
