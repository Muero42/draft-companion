...
assert.match(app,/const APP_VERSION='v11\.8\.0-rc4\.82'/);
...
assert.ok(idx.includes('v11.8.0-rc4.82'));
assert.ok(sw.includes('v11.8.0-rc4.82'));
assert.ok(manifest.includes('v11.8.0-rc4.82'));
