...
// Draft-day UI no longer exposes the obsolete incumbent/v2 selector. The legacy profiles
// remain internal regression baselines, while the authoritative analysis selector is v3/v4/v5.
