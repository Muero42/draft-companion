...
- Current handoff generation = **20260911T0607Z-v238**. This checkpoint records the rc4.194 Waiver/Trade feature package while preserving the physical rc4.193 Weekly-Evidence PASS.
- Current mode = **POST_DRAFT_SEASON_COMPANION**.
- Canonical source candidate = **rc4.194 PR-only Waiver/Trade feature package on Draft PR #141; not merged, deployed or physically accepted**. Verify the exact current main HEAD dynamically; a tracked checkpoint must not hard-code its own containing commit as immutable current authority.
...
- Source candidate v11.8.0-rc4.194 is PR-only; latest physical Android rc4.193 Weekly-Evidence PASS; rollback rc4.169; deployment parity UNKNOWN_REQUIRES_REVERIFICATION. PR #121 / v233 MERGED/HISTORICAL. No rc4.194 deployment or device acceptance is claimed.
...
Earlier rc4.190/rc4.192 identities are historical. rc4.193 is the physical Weekly-Evidence PASS; rc4.194 remains the unpromoted candidate.
